...
const Footer = () => {
  return (
    <div className='w-full  mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300 justify-center' id='footer'>
      <div className='mx-20'>
      ...
      <div className='lg:col-span-2 flex justify-between mt-6'>
        ...
        <div>
          <h6 className='font-medium text-gray-400'>For Developers</h6>
          <ul>
            <li className='py-2 text-sm'><a href="https:ui.aceternity.com" target='_blank' rel='noreferrer'>Aceternity</a></li>
            <li className='py-2 text-sm'><a href="https://getbootstrap.com/" target='_blank' rel='noreferrer'>Bootstrap</a></li>
            <li className='py-2 text-sm'><a href="https://tailwindcss.com/" target='_blank' rel='noreferrer'>Tailwindcss</a></li>
