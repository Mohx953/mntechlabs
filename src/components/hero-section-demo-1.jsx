    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          ...
          {"We Make Web Apps That Meet Your Every Day Needs"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        <motion.p
          ...
          From tracking your budget to checking the weather and never missing a score — MNT Labs builds the tools that run your day.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
          ...
          <a href="#cards"
            className="inline-block text-center w-60 transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
            Explore Now
          </a>
          <a href="https://wa.me/26879727921/" target="_blank"
            className="w-60 transform rounded-lg text-center border border-gray-300 bg-white px-6 py-2 font-medium text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-100 dark:border-gray-700 dark:bg-black dark:text-white dark:hover:bg-gray-900">
            Contact Support
          </a>
        </motion.div>
        {/* <motion.div
