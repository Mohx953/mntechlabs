...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-screen md:h-screen bg-gradient-to-b from-black to-neutral-800 dark:from-neutral-950 dark:to-neutral-800 relative  items-center w-full  overflow-hidden",
